                                ...
                                <div class="basic-form">
                                    <form  action="epayment.php" method="POST"> 
                                        ...
                                        <div class="row">
                                                ...
                                                <select id="inputState" name="E_state" class="default-select form-control wide">
                                                  
                                                </select>
                                            </div>
                                            <div class="mb-3 ">
                                                <label class="form-label">Electricity Board </label>
                                                        <select id="inputElectricity" name="E_board" class="default-select form-control wide">
                                        ...
                                        <div class="row">
                                            <div class="mb-3 ">
                                               ...
                                               <input type="text" name="mobilenumber_new" class="form-control"  placeholder="Enter Valid Number">
                                            </div>
