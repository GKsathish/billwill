...
<div class="dlabnav">
    <div class="dlabnav-scroll mm-active ps">
        <ul class="metismenu mm-show" id="menu">
            ...
            <li><a href="home.php" class="ai-icon" aria-expanded="false">
            ...
            <li><a href="offers.php" class="ai-icon" aria-expanded="false">
                    <span class="nav-text">Offer's</span>
                </a>
            </li>
            <li><a href="redeem_vouchers.php" class="ai-icon" aria-expanded="false">
                    <span class="nav-text">Redeem Vouchers</span>
                </a>
            </li>
            <li><a href="Refer.php" class="ai-icon" aria-expanded="false">
                    <span class="nav-text">Refer & Earn</span>
                </a>
            </li>
            <li><a href="Help.php" class="ai-icon" aria-expanded="false">
