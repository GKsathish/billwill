       ...
       <img src="images/logo.png">
        ...
        <div class="dlabnav">
            <div class="dlabnav-scroll">
                    ...
                    <li><a href="Recharge.html" class="ai-icon" aria-expanded="false">
                                ...
                                <div class="basic-form">
                                    <form>
                                        ...
                                        <div class="row">
                                                ...
                                                <select id="inputDth" class="default-select form-control wide">
                                                    <option selected>Choose a Operator</option>
                                            ...
                                            <div class="mb-3 ">
                                                <label class="form-label">Card Number/Regisiter Number</label>
                                        ...
                                        <div class="row">
                                              <div class="mb-3 ">
                                                ...
                                                <input type="text" class="form-control" placeholder="Enter Amount">
                                                    ...
                                                    <a href="#" class="show_plans" style="color:#0665f3;"> *View all plans</a>
                                        </div>
                    ...
                    <div class="card plans">
                           <div class="card-header">
                                <h4 class="card-title">Recharge Plans</h4>
                                 ...
                                 <div class="tab">
                                  <button class="tablinks" onclick="openCity(event, 'London')" id="defaultOpen">Monthly Pack</button>
                                  <button class="tablinks" onclick="openCity(event, 'Paris')">3 Month Packs</button>
                                  <button class="tablinks" onclick="openCity(event, 'Tokyo')">6 Month/Annual Packs</button>
                            </div>
                        ...
                        <div class="card-body">
                            <div id="London" class="tabcontent">
                                        ...
                                        <tbody>
                                            <tr>
                                                <td><span class="badge badge-success">555</span>
                                                </td>
                                            ...
                                            <tr>
                                                 <td><span class="badge badge-info light">666</span>
                                                </td>
                                                
                                                <td><span class="text-muted">Oct 12, 2017</span>
                                                </td>
                                                <td>NA</td>
                                               <td>limited calls & SMS 100 per day</td>
                                                
                                                
                                            </tr>
                                            <tr>
                                                   <td><span class="badge badge-danger">599</span>
                                                </td>
                                                 <td><span class="text-muted">Oct 12, 2022</span>
                                                <td>NA</td>
                                            ...
                                            <tr>
                                                <td><span class="badge badge-success">239</span>
                                                </td>
